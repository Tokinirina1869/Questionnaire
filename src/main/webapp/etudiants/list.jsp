            ...
            <div class="p-4 border-b border-gray-700">
                <form method="GET" action="<%= request.getContextPath() %>/etudiants" 
                    ...
                    <input type="text" name="q" 
                           ...
                           class="w-full md:w-80 px-4 py-2
                                  rounded-lg text-sm focus:outline-none focus:border-blue-500 transition-colors"/>
                    <button type="submit"
                        ...
                        <tr class="hover:bg-gray-800 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="font-medium"><%= e.getNom() %></span>
                                    <span class="text-xs "><%= e.getPrenoms() %></span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center gap-3">
                                    ...
                                    <a href="<%= request.getContextPath() %>/etudiants?action=edit&id=<%= e.getNumEtudiant() %>"
